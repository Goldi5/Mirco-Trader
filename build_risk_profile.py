...
lines.append('    max_pos = max(4, min(8, 8 - (risk // 20)))  # 8 bei Risk 0 → 4 bei Risk 95 (viele kleine statt wenige teure)')
lines.append('    pos_size = 0.15 + (risk / 100) * 0.25  # 0.15 bei Risk 0 → 0.40 bei Risk 95 (kleinere Klumpen)')
