#!/usr/bin/env python3
"""Diagnostic 3: real 20-depot batch prompt via risk_profile RISK_STUFEN."""
import os, sys, json, re
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
os.chdir(os.path.dirname(os.path.abspath(__file__)))

from ki_provider import call_ki
from risk_profile import RISK_STUFEN, fuer_risk_stufe
...
try:
    ...
    print("PARSE OK:", len(entscheidungen), "Depots | Provider:", provider)
except Exception as e:
    print("PARSE FEHLER:", e, "| Provider:", provider)
    ...
    if m:
        ...
        if ln <= len(lines):
            ...
            print(f"--- Fehler bei Spalte {col}: '{lines[ln-1][max(0,col-40):col+15]}'")
